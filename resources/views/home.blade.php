                    ...
                    <div class="-ml-10 flex flex-wrap flex-col md:flex-row">
                        ...
                        <div class="flex flex-2 w-full pl-10 my-4">
                            <div class="uk-card p-8 bg-grey-light">
                                <h6 class="text-lg uppercase mb-4">Who We Are</h6>
                                <h3 class="text-3xl font-hairline">Our Mission</h3>
                                <p class="mt-4 mb-8 font-light leading-normal">The Stoughton Police Relief Association consists of 2205 sworn officers and civilian personnel whom have taken an oath to maintain law and order for our citizens, and represent the finest element of our community.</p>
